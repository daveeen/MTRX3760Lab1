...
class CHeater : public CDevice
{
  public:
    ...
    void SetHeatSetting( int aSetting );      // set the heater's heat setting
    int PowerDraw();                          // power drawn, in watts
...
int main()
{
  ...
  CDevice* devices[NumDevices] = { &driveMotor, &statusLed, &centralheater };
...
void CHeater::SetHeatSetting( int aSetting )
{
  mHeatSetting = aSetting;
}
